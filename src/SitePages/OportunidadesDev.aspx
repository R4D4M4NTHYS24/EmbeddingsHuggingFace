...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	<link href="http://localhost:3305/Demos.css" rel="stylesheet"></link>	
...
<body>
	...
	<form id="form1" runat="server">
		...
		<script id="responsive-column-template" type="text/x-kendo-template">
			<fieldset class="box">
		        ...
		        <p class="col-template-val">#=data.Cliente#</p>
		
		        <strong>UnitPrice</strong>
		        <p class="col-template-val">#=data.AsignadoText#</p>
		
		        <strong>UnitsInStock</strong>
		        <p class="col-template-val">#=data.TipoDemo#</p>
		
		        <strong>Discontinued</strong>
		        <p class="col-template-val">#=data.FechaRealizacion#</p>
	...
	<script type="text/javascript" src="/sites/Intranet/SiteAssets/js/kendo-culture/kendo.culture.es-CO.min.js"></script>
	<script type="text/javascript" src="/sites/Intranet/SiteAssets/js/kendo-culture/kendo.messages.es-CO.min.js"></script>
      
	<script src="https://cdnjs.cloudflare.com/ajax/libs/jszip/2.4.0/jszip.js"></script>
	<script type="text/javascript" src="/sites/Intranet/Style Library/Libs/kendo.messages.es-CO.min.js"></script>
	
	<script src="http://localhost:3305/Demos.js"></script>
